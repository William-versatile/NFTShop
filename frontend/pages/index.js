...
import { abi, NFTSHOP_CONTRACT_ADDRESS } from "../constants";
...
export default function Home() {
  ...
  const presaleMint = async () => {
    try {
      ...
      // update methods
      const nftContract = new Contract(NFTSHOP_CONTRACT_ADDRESS, abi, signer);
  ...
  const checkIfPresaleStarted = async () => {
    try {
      ...
      const nftContract = new Contract(NFTSHOP_CONTRACT_ADDRESS, abi, provider);
      ...
      return (
        <div>
          <div className={styles.description}>
            Presale has started!!! If your address is whitelisted, Mint a NFT from NFTShop 🥳
          </div>
    ...
    <div>
      ...
      <div className={styles.main}>
        <div>
          ...
          <div className={styles.description}>
            Its an NFT collection for anyone who loves NFTs.
          </div>
          <div className={styles.description}>
